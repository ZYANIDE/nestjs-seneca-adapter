declare module '@nestjs/microservices/microservices-module' {
    ...
    class MicroservicesModule<TAppOptions extends NestApplicationContextOptions = NestApplicationContextOptions> {
        ...
        bindListeners(controllers: Map<string | symbol | Function, InstanceWrapper<Controller>>, // eslint-disable-line
        server: Server & CustomTransportStrategy, moduleName: string): void;
